...
--member
INSERT INTO MEMBER ( ACCOUNT, PASSWORD, NAME, TYPE, EMAIL ,TEL, MOBILE, COUNTY, DISTRICT, ADDRESS, EMAIL_VERTIFICATION, SIGN_UP_DATE)
VALUES('sheila1112','asdf','sheila', 'P', 'sheila000@gmail.com','25644433', '0912356278','台北市','大安區','復興南路一段390號15樓', 'Y','2015-5-13');

INSERT INTO MEMBER (ACCOUNT, PASSWORD,NAME, TYPE, EMAIL, TEL, MOBILE, COUNTY, DISTRICT, ADDRESS, EMAIL_VERTIFICATION, SIGN_UP_DATE)
VALUES('anchor1112','asdf','anchor', 'P', 'anchor001@gmail.com','25644433', '0912356278','台南市','安南區','大眾路360號', 'N','2015-2-23');

INSERT INTO MEMBER (ACCOUNT, PASSWORD,NAME, TYPE, EMAIL, ORG_FOUNDER, ORG_CEO,TEL, MOBILE, COUNTY, DISTRICT, ADDRESS,EMAIL_VERTIFICATION, SIGN_UP_DATE, ORG_IDENTITY_CONFIRMATION)
VALUES('jasmine1112','asdf','jasmine', 'O', 'jasmine002@gmail.com','Tom老師', '鄭正','25644433', '0912356278','台中市','東區','大勇街28號', 'N','2015-6-8','N');
