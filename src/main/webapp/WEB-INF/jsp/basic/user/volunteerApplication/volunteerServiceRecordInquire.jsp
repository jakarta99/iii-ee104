...
//                    if(order.orderStatus ==)
        	...
        	if(orders.content.length != 0){
	        	...
	        	for (var index = 1; index <= totalPages ; index++) {
	        		$("#nextli").before("<li class='page-item' data-toggle='pill' href='javascript: void(0)' role='tab' aria-controls='pills-home' aria-selected='true'><a name='count' id="+index+" class='page-link'>"+index+"</a></li>")
				}	        		
        	}
	 	})
 	}
